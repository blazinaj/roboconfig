...
const CommunicationPage: React.FC = () => {
  ...
  // Filter for Communication components from the database
  const communicationComponents = components.filter(
    ...
    <MainLayout>
      {showForm ? (
        ...
        <ComponentListLayout
          ...
          description="Manage network interfaces and communication systems"
