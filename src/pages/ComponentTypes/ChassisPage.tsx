...
const ChassisPage: React.FC = () => {
  ...
  const chassisComponents = componentData.filter(
    ...
    <MainLayout>
      <div className="mb-6">
        <div className="flex justify-between items-center mb-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Chassis Components</h1>
            <p className="text-gray-600">Manage frames, mounts, and structural components</p>
          </div>
          <button
        ...
        <div className="flex space-x-4 mb-6">
          <div className="relative flex-1">
            ...
            <input
              ...
              placeholder="Search chassis components..."
        ...
        {!showForm && filteredComponents.length === 0 && (
          <div className="text-center py-12 bg-gray-50 rounded-lg">
            ...
            <p className="text-gray-500">
              Try adjusting your search or add a new chassis component.
            </p>
          </div>
        )}
      </div>
