...
import { Battery, Plus, X, AlertTriangle, Loader2, Bot } from 'lucide-react';
...
const PowerForm: React.FC<PowerFormProps> = ({ onSubmit, onCancel, initialData }) => {
  const {
    formData,
    setFormData,
    loading,
  ...
  const handleFormSubmit = async (e: React.FormEvent) => {
    ...
    if (success) {
      onSubmit({...formData, category: 'Power'});
    }
  };
    ...
    <div className="bg-white rounded-lg shadow-md p-6 relative">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center">
          <Battery className="text-yellow-500 mr-2" size={24} />
          <h2 className="text-xl font-semibold text-gray-900">Power Component</h2>
        </div>
          ...
          <form onSubmit={handleFormSubmit} className="space-y-6">
            ...
            <div>
              ...
              >
                ...
                <option value="charge systems">Charge Systems</option>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateSpecification('capacity', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => updateSpecification('current', e.target.value)}
                    className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"
                    placeholder="e.g., 10A"
                  />
                </div>
